                                ...
                                <table class="table" style="margin-bottom: 0;">
                                    ...
                                    <c:forEach items="${students}" var="student" varStatus="index">
                                        <tr>
                                            ...
                                            <td>${student.realUame}</td>
                                            <td>${student.studentNum}</td>
                                            <td>${student.password}</td>
                                            <td>
                                                <a href="${ctx}/student/update?id=${student.id}" class="btn btn-info">修改</a>
                                                <a href="${ctx}/student/delete?id=${student.id}" class="btn btn-danger">删除</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
