                    ...
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">新闻编辑</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <form action="${ctx}/news/add" method="post" novalidate="novalidate">
                                            <input type="hidden" name="role" value="admin">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">标题</label>
                                                <input id="cc-payment" name="title" type="text" class="form-control" value="${student.realUame}">
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">内容</label>
                                                <input id="cc-name" name="content" type="text" class="form-control cc-name valid" value="${student.studentNum}">
                                            </div>
                                            <div>
