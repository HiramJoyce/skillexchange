                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">站内新闻管理</strong>
                                <a class="btn btn-success btn-sm" href="${ctx}/news/add">添加</a>
                            </div>
                                ...
                                <table class="table" style="margin-bottom: 0;">
                                    ...
                                    <c:forEach items="${news}" var="newss" varStatus="index">
                                        <tr>
                                            ...
                                            <td>${newss.title}</td>
                                            <td>${newss.content}</td>
                                            <td><f:formatDate value="${newss.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                            <td>
                                                <a href="${ctx}/news/delete?id=${newss.id}" class="btn btn-danger">删除</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
